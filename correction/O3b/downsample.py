...
# ==============================================================================
# This file has been modified to obtain O3b data rather than O3a.
# ==============================================================================
...
def get_raw_segments(dets):
    start_time = 1256655618 #Start O3b
    end_time = 1269363618 #End O3b
    ret = {}
...
def main():
    ...
    for seg in iterator:
        ...
        for det in args.detectors:
            ...
            ts = query_and_read_frame(f'{det}_GWOSC_O3b_4KHZ_R1',
